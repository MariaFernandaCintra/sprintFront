...
export default function FiltroModal({ visible, onClose, onApplyFilters }) {
  ...
  const diasSemanaKeys = Object.keys(diasSemanaMap)
    .map(Number)
    .filter((key) => key !== 0);
    ...
    <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={ptBR}>
      ...
      >
        ...
        <DialogContent dividers sx={styles.dialogContent}>
          ...
          >
            <Typography sx={styles.applyButtonText}>Aplicar Filtros</Typography>
          </Button>
        </DialogContent>
      </Dialog>
